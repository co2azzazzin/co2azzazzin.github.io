...
// Adapted from Benedikt Bitterli's c++ tutorial : http://www.gamedev.net/page/resources/_/technical/math-and-physics/a-verlet-based-approach-for-2d-game-physics-r2714
	...
	function () {
		...
		for (var i = 0; i < codepen.length; i++) {
			...
			for (var j = 0; j < line.length; j++) {
				var c = line.charAt(j);
				if (c != " ") verletEngine.createRectangle(w * 0.5 + w * j, h + w * i, w * 0.8, w * 0.8);
			}
		}
